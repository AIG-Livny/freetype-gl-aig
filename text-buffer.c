...
// ----------------------------------------------------------------------------
void
text_buffer_printf( text_buffer_t * self, struct vec2f *pen, ... )
{
    markup_t *markup;
    char *text;
    va_list args;
...
//
static void
text_buffer_finish_line( text_buffer_t * self, struct vec2f * pen, bool advancePen )
{
...
text_buffer_add_text( text_buffer_t * self,
                      struct vec2f * pen, markup_t * markup,
...
// ----------------------------------------------------------------------------
void
text_buffer_align( text_buffer_t * self, struct vec2f * pen,
